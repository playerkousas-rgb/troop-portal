...
const UPDATES = [
  { date: '2026-08-31', version: 'v2.1.0', title: '管理中心重整 + 活動過期區', items: ['管理中心以統計資料置頂，再按 6 大管理項目進入', '活動加入「過期區」，已過期活動保留集合資料', '行事曆支援匯出 ICS 及訂閱 Google 日曆', '管理員可在活動、公告、行事曆頁直接處理'] },
  { date: '2026-08-20', version: 'v2.0.0', title: '系統大更新 · 新 UI', items: ['全新 Scout Portal UI', '首頁加入「新旅團申請及教學」', '活動通告同公告通知分開處理', '點名頁面初版'] },
  { date: '2026-08-01', version: 'v1.5.0', title: '行事曆同活動改善', items: ['行事曆檢視模式（月／週／清單）', '活動可直接回覆參加／有興趣', '類別過濾（旅團活動 / 區總會活動）'] },
  { date: '2026-07-15', version: 'v1.0.0', title: 'Scout Portal 正式上線', items: ['首版系統上線', '支援旅團選擇同登入', '基本行事曆、公告、活動功能', 'Google Sheet 後台連接'] },
];
