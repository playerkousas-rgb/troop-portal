...
const UPDATES = [
  { date: '2026-09-01', version: 'v2.1.0', title: '管理中心重整 + 活動過期區', items: ['管理中心搬去儀表板，6 大模組卡片顯示', '活動加入「過期區」，已過期通告唔刪除', '行事曆支援 ICS 匯出同 Gmail 同步', '物資管理模組（MOCK 展示）'] },
  { date: '2026-08-20', version: 'v2.0.0', title: '系統大更新 · 新 UI', items: ['全新 Scout Portal UI', 'MOCK 演示模式上線', '首頁加入「新旅團申請及教學」', '活動同公告分開處理', '點名頁面初版（MOCK）'] },
