    ...
    <main className="max-w-4xl mx-auto px-4 py-4 pb-24 space-y-4">
      ...
      <div className="flex gap-2 flex-wrap">
        <div className="flex-1 min-w-[200px]">
          <label className="text-[9px] font-bold text-slate-500">🏠 旅團內部活動</label>
        ...
        <div className="flex-1 min-w-[200px]">
          <label className="text-[9px] font-bold text-slate-500">📚 外部（圖書館）活動</label>
        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              <div key={i} className={`${s.bg} rounded-xl px-2 py-2 text-center`}>
                ...
                <div className={`text-[8px] font-semibold ${s.text} opacity-80`}>{s.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button className="text-[9px] bg-emerald-600 text-white px-2 py-1 rounded-lg font-bold">📥 匯出 CSV</button>
            </div>
                ...
                <div key={i} className="flex items-center justify-between bg-slate-50 rounded-xl px-3 py-2">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[8px] text-slate-400">{r.branch} · {r.patrol || '—'}</span>
                    </div>
                  </div>
                  <div className="flex gap-1 items-center flex-shrink-0">
                    ...
                    {r.paid !== 'confirmed' && r.status === 'registered' && (
                      <button className="text-[8px] bg-emerald-600 text-white px-1.5 py-0.5 rounded font-bold ml-1">✓ 核實</button>
                    )}
                  </div>
                </div>
              ))}
