  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-4 pb-24 space-y-5">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <Link href="/dashboard" className="text-[11px] font-bold text-slate-500 no-underline hover:text-brand-700">← 返回控制台</Link>
          <h1 className="font-black text-xl text-slate-900 m-0 mt-1">🔧 管理中心</h1>
          <p className="text-[11px] text-slate-500 m-0 mt-1">管理權人士可在這裡進入各項管理；日常操作仍可在行事曆、公告及活動頁直接處理。</p>
        </div>
        <span className="text-[11px] font-black bg-amber-100 text-amber-800 border border-amber-200 rounded-full px-2.5 py-1">🎨 MOCK 管理中心</span>
      </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[11px] text-slate-500">更新於剛才</span>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
          {STATS.map(stat => (
            <div key={stat.label} className={`rounded-2xl border p-3 ${toneStyles[stat.tone]}`}>
              ...
              <div className="text-[11px] opacity-75 mt-0.5">{stat.note}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-5">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div>
            ...
            <p className="text-[11px] text-slate-500 m-0 mt-1">點擊卡片直接進入管理頁面</p>
          </div>
          <span className="text-[11px] font-bold text-slate-400">6 個模組</span>
        </div>
              ...
              <div className="h-full rounded-2xl border border-slate-200 bg-white p-3.5 transition hover:-translate-y-0.5 hover:border-brand-300 hover:shadow-md">
                ...
                <div className="flex items-start justify-between gap-2 mt-3">
                  <div>
                    ...
                    <p className="text-[11px] text-brand-700 font-bold m-0 mt-1">{module.subtitle}</p>
                  </div>
                  <span className="text-slate-400 group-hover:text-brand-600 font-black">→</span>
                </div>
                <p className="text-[11px] text-slate-500 m-0 mt-1.5 leading-relaxed">{module.detail}</p>
              </div>
            </Link>
          ))}
        </div>
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        <Link href="/dashboard/admin/applications" className="no-underline text-inherit bg-white border border-slate-200 rounded-xl px-3 py-2.5 hover:border-brand-300 transition">
          <div className="text-sm">✅</div><div className="font-bold text-[11px] mt-1">批核中心</div><div className="text-[11px] text-slate-500">申請及審批</div>
        </Link>
        <Link href="/dashboard/admin/settings" className="no-underline text-inherit bg-white border border-slate-200 rounded-xl px-3 py-2.5 hover:border-brand-300 transition">
          <div className="text-sm">⚙️</div><div className="font-bold text-[11px] mt-1">系統設定</div><div className="text-[11px] text-slate-500">公開瀏覽及接入</div>
        </Link>
        <Link href="/dashboard/admin/members" className="no-underline text-inherit bg-white border border-slate-200 rounded-xl px-3 py-2.5 hover:border-brand-300 transition">
          <div className="text-sm">🏢</div><div className="font-bold text-[11px] mt-1">支部及小隊</div><div className="text-[11px] text-slate-500">成員分組</div>
        </Link>
        <Link href="/dashboard/notices" className="no-underline text-inherit bg-white border border-slate-200 rounded-xl px-3 py-2.5 hover:border-brand-300 transition">
          <div className="text-sm">📢</div><div className="font-bold text-[11px] mt-1">公告管理</div><div className="text-[11px] text-slate-500">通知類訊息</div>
        </Link>
      </section>
    </main>
  );
